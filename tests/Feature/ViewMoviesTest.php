...
class ViewMoviesTest extends TestCase
{
    ...
    public  function the_main_page_shows_correct_info()
    {
        Http::fake([
            ...
            'https://api.thmemoviedb.org/3/movie/now_playing' => $this->fakeNowPlayingMovies(),
            // 'https://api.thmemoviedb.org/3/movie/list'=>$this->fakeGenres(),
        ]);
        $resposta = $this->get(route('movies.index'));

        $resposta->assertSuccessful();
        $resposta->assertSee('Now Playing');
        // $resposta->assertSee('Fake Movie');
        // $resposta->assertSee('Science Fiction , Action , Adventure , Thriller ');
        // $resposta->assertSee('Now Playing');
        // $resposta->assertSee('Now Playing Fake Movie');
    }
