                        ...
                        @if (count($tvshow['videos']['results']) > 0)
                            <div class=" mt-12">
                                <button @click="isOpen = true"
                                    class="flex inline-flex items-center bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease duration-150">
                                ...
                                </button href="https://youtube.com/watch?v={{ $tvshow['videos']['results'][0]['key'] }}">
                            </div>
                        @endif
            ...
            <div class="fixed top-0 left-0 w-full h-full flex items-center shadow-lg overflow-y-auto"
                ...
                <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                    <div class="bg-gray-900 rounded">
                        <div class="flex justify-end pr-4 pt-2">
                            <button class="text-3xl leading-none hover:text-gray-300"
                                @keydown.escape.window="isOpen = false" @click="isOpen = false">&times;</button>
                        </div>
                        <div class="modal-body px-8 py-8">
                            <img :src="image" alt="">
                        </div>
